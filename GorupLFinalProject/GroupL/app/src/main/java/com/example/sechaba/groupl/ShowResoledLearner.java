...
public class ShowResoledLearner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_resoled_learner);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setIcon(R.mipmap.me3);
        actionBar.setTitle("Resolved Report");
        actionBar.setDisplayUseLogoEnabled(true);
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);
        listreports = (ListView) findViewById(R.id.learnerreportshow);
        reportdata();
    }
    ...
    public void reportdata() {
        ...
        String whereClause = "status = 'Resolved'";
    ...
    public void onBackPressed() {
        super.onBackPressed();
        ShowResoledLearner.this.finish();
    }
